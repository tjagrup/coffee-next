...
IMAGE_IDS = sorted(set([
    ...
    # Espresso Drinks
    1233528, 9249368, 312418, 2396220, 12703064,
    2074127, 6205779, 32053480, 373639, 324028, 6802983,
    # Cold Drinks
    10738363, 2775860, 8605616, 34170574, 5946967, 5946969,
    24039577, 102444, 5817518,
    # Loose Leaf Tea
    ...
    # Sandwiches
    3957501, 31126255, 17498978, 30925490, 4109507, 33706245,
    1640777, 4397295, 3616956, 13427800,
]))
